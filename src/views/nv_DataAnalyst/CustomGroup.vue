<template>
	<el-row class='myPadding'>
		<el-col :span="24" class='groupTitle' v-loading="loading" element-loading-text="加载中">
          ...
          <el-form-item>
	                    <el-button type="primary" @click='queryGroupFn'>查询</el-button>
	                    
	       </el-form-item>
          <el-form-item>
                		<!-- <el-button type="primary" @click='outDataExl'>导出数据</el-button>	 -->
          </el-form-item>
			...
			<el-col :span='3'>
				<el-button type="primary" @click="addGroup">自定义分组</el-button>
				<el-dialog
				  title="分组"
				  ...
				  top='8%'
				  >
				  <span>分组名称：</span><el-input type='text' class='groupName'  placeholder="请输入分组名称" v-model='groupName'></el-input>
				  ...
				  <span slot="footer" class="dialog-footer">
				    ...
				    <el-button type="primary" @click="complieFinish">确 定</el-button>
				  </span>
				</el-dialog>
			</el-col>
...
<script>
import { GetGroupLoggers, addGroup, queryGroup, delateGroup,updateGroup } from '../../api/api'
var today = new Date();
    today.setHours(0);
    today.setMinutes(0);
    today.setSeconds(0);
